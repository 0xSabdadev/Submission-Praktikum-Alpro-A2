/*Nama File 	: JuruMasakTerbaik.c
  ...
  Pembuat   	: 24060121120025 - Annisa Kumala Dewi
  Tgl Pembuatan	: 29 April 2022 - 02.07*/
...
int main()
{
    ...
    printf("\n");
    printf("total 3 nilai terbesar untuk juru masak pertama : %d\n", sum1);
    printf("total 3 nilai terbesar untuk juru masak kedua : %d\n", sum2);
