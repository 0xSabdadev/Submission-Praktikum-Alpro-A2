...
//Deskripsi     : Membuat program untuk membantu ancient one dalam mencari kandidat terbaik untuk sorcerer supreme
...
int main(void)
{
    ...
    // Algoritma
    printf("Jumlah keseluruhan kandidat: ");
    scanf("%d", &N);

    printf("Jumlah kandidat yang dibutuhkan: ");
    scanf("%d", &T);
